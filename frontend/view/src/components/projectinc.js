...
import "./projectinc.css"

export default class Projectinc extends Component {
    ...
    render() {
        ...
        return (
            <div className="ProjectInit" align="center">
                                    ...
                                    return (
                                        <div key={idx}>
                                            <div className="test border border-dark rounded">
                                                ...
                                                <h6>
                                                    <b>
                                                        All weights should sum up to 100. Allocate weight to each
                                                        category. For example: Skill Weight: 20, Experience Weight: 25,
                                                        Hours Weight: 15, Language Weight: 0, Budget Weight: 40
                                                    </b>
                                                </h6>
                                                <div className="form-row">
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
